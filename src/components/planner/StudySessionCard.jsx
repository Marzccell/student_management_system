...
export default function StudySessionCard({ session, onEdit, onDelete, showDate = false }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 transition-all duration-200 hover:shadow-md hover:-translate-y-0.5 animate-fade-in">
      <div className="flex items-start justify-between gap-3 mb-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-sm text-gray-800">{session.subject}</h3>
